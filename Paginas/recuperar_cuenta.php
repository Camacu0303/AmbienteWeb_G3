...
<body>
    <div class="recovery-container">
        ...
        <div class="recovery-form-container">
            ...
            <p class="recovery-instructions">Introduce tu correo electrónico para enviarte un email con una contraseña
                temporal</p>

            <form action="recuperar_cuenta.php" method="post" class="recovery-form">
